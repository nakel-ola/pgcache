...
- 9c03fd4: Add `delIfEquals` method for safe distributed lock releases. This method performs a compare-and-delete operation, only deleting a key if its value matches the expected value.
